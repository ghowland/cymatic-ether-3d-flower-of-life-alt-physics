...
**Series Path:** [CKS-MATH-12-2026] → [CKS-LANG-4-2026] → [CKS-BIO-8-2026] → **[CKS-LANG-9-2026]**  
...
/p/ = bilabial plosive = boundary impulse at terminal M_max
...
#### 2.1.1 /p/ — Bilabial Voiceless Plosive
...
#### 2.1.2 /b/ — Bilabial Voiced Plosive
...
#### 2.1.3 /t/ — Alveolar Voiceless Plosive
...
#### 2.1.4 /d/ — Alveolar Voiced Plosive
...
#### 2.1.5 /k/ — Velar Voiceless Plosive
...
|---------|---------|-------|--------|----------|----------------|
| /p/ | Voiceless | Lips | BOUNDARY_PING | Terminal reset | Output prep |
| /b/ | Voiced | Lips | PING + CARRIER | Damped terminal | Output + tone |
| /t/ | Voiceless | Alveolar | GATE_LOCK | Checksum write | CLOCK (T in T-P) |
| /d/ | Voiced | Alveolar | LOCK + CARRIER | Damped gate | Soft clock |
| /k/ | Voiceless | Velar | NODE_ASSIGN | Lattice quantize | SNAP (K in K-M-T) |
| /g/ | Voiced | Velar | ASSIGN + CARRIER | Damped node | Soft snap |
...
#### 2.2.1 /f/ — Labiodental Voiceless Fricative
...
#### 2.2.2 /v/ — Labiodental Voiced Fricative
...
#### 2.2.3 /θ/ — Dental Voiceless Fricative (as in "think")
...
#### 2.2.4 /ð/ — Dental Voiced Fricative (as in "this")
...
#### 2.2.5 /s/ — Alveolar Voiceless Fricative
...
#### 2.2.6 /z/ — Alveolar Voiced Fricative
...
#### 2.2.7 /ʃ/ — Postalveolar Voiceless Fricative (as in "ship")
...
#### 2.2.8 /ʒ/ — Postalveolar Voiced Fricative (as in "measure")
...
#### 2.2.9 /h/ — Glottal Voiceless Fricative
...
|---------|---------|-------|--------|----------|-----------------|
| /f/ | Voiceless | Labiodental | BOUNDARY_DITHER | Terminal scrub | 2-8 kHz |
| /v/ | Voiced | Labiodental | DITHER + CARRIER | Terminal + tone | 2-8 kHz + 100-200 Hz |
| /θ/ | Voiceless | Dental | FINE_DITHER | Precision purge | 4-10 kHz |
| /ð/ | Voiced | Dental | FINE_DITHER + CARRIER | Precision + tone | 4-10 kHz + 100-200 Hz |
| /s/ | Voiceless | Alveolar | BUFFER_WIPE | Aggressive clear | 4-12 kHz |
| /z/ | Voiced | Alveolar | WIPE + CARRIER | Aggressive + tone | 4-12 kHz + 100-200 Hz |
| /ʃ/ | Voiceless | Postalveolar | WIDE_DITHER | Diffuse clear | 2-8 kHz |
| /ʒ/ | Voiced | Postalveolar | WIDE_DITHER + CARRIER | Diffuse + tone | 2-8 kHz + 100-200 Hz |
| /h/ | Voiceless | Glottal | SOURCE_VENT | Core exhaust | 0.5-2 kHz |
...
When you hum "Mmmmmm" for 5-10 seconds:
...
#### 2.3.3 /ŋ/ — Velar Nasal (as in "sing")
...
**Note:** English does NOT allow /ŋ/ at word START (no words begin with "ng" sound). CKS predicts: /ŋ/ is a TERMINAL charge, not an initial one — used to sustain resonance after other opcodes establish it.
...
|---------|-------|--------|-------------------|-----------|----------------|
| /m/ | Lips | ANTENNA_CHARGE | Full skull | 100-250 Hz | COUPLE (M in K-M-T) |
| /n/ | Alveolar | SYNC_CHARGE | Nasal + spine | 100-300 Hz | Vertical sync |
| /ŋ/ | Velar | DEEP_CHARGE | Skull base + chest | 80-200 Hz | Core coupling |
...
#### 2.4.1 /l/ — Alveolar Lateral Approximant
...
#### 2.4.2 /r/ — Postalveolar Approximant
...
#### 2.4.3 /w/ — Labial-Velar Approximant
...
#### 2.4.4 /j/ — Palatal Approximant (as in "yes")
...
|---------|-------|--------|--------------|----------------|
| /l/ | Alveolar lateral | LAMINAR_FLOW | Bilateral smooth | STREAM (L in L-A-E) |
| /r/ | Postalveolar | VORTEX_INIT | Centripetal spiral | Soliton stabilize |
...
**CKS function:** Resonant tuning — vocal tract shape determines which M-shell in vertical dipole is activated; each vowel = specific rung on ladder from pelvis (10⁴²) to skull (10⁴³).

---

#### 2.5.1 Vowel Space Topology

**Standard phonetics:** Vowels mapped in 2D space:
...
Vertical axis = M-shell selection
  High vowels = High M (skull, 10⁴³)
  Low vowels = Low M (pelvis, 10⁴²)

Horizontal axis = Sector selection
  Front vowels = Anterior sector (s₀)
  Central vowels = Neutral (balanced)
  Back vowels = Posterior sector (s₁, s₂)
```

**The vertical dipole:**

```
10⁴³ nodes (skull, antenna peak)
  ↑
...
#### 2.5.2 High Front Vowels (Antenna Peak)

**2.5.2.1 /i/ — "ee" as in "beet"**
...
Frequency: F1 ≈ 400 Hz, F2 ≈ 2000 Hz
```
...
#### 2.5.3 High-Mid Front Vowels

**2.5.3.1 /e/ — "ay" as in "bait"**

**Articulation:**
```
Tongue: High-mid, front
Lips: Slightly spread
Jaw: More open than /ɪ/
```
...
Frequency: F1 ≈ 500 Hz, F2 ≈ 1900 Hz
```
...
Frequency: F1 ≈ 700 Hz, F2 ≈ 1800 Hz
```
...
#### 2.5.4 Low Front Vowels

**2.5.4.1 /æ/ — "ah" as in "bat"**
...
M-shell: ~0.3 × 10⁴³
Resonance: Throat
Frequency: F1 ≈ 800 Hz, F2 ≈ 1600 Hz
```
...
#### 2.5.5 Central Vowels (Neutral/Schwa)

**2.5.5.1 /ə/ — "uh" as in "about" (SCHWA)**
...
Frequency: F1 ≈ 500 Hz, F2 ≈ 1500 Hz (very neutral)
```
...
Frequency: F1 ≈ 700 Hz, F2 ≈ 1400 Hz
```
...
#### 2.5.6 Low Back Vowels (Ground Sink)

**2.5.6.1 /ɑ/ — "ah" as in "father"**
...
M-shell: ~0.2 × 10⁴³ (approaching pelvis)
Resonance: Deep throat/upper chest
Frequency: F1 ≈ 700 Hz, F2 ≈ 1100 Hz (very low F2)
```
...
**Note:** In many American dialects, /ɔ/ merges with /ɑ/ (cot-caught merger). CKS predicts: This merger reduces M-shell resolution in lower ranges.

---

#### 2.5.7 High-Mid Back Vowels

**2.5.7.1 /o/ — "oh" as in "boat"**
...
#### 2.5.8 High Back Vowels

**2.5.8.1 /ʊ/ — "oo" as in "book"**
...
Frequency: F1 ≈ 400 Hz, F2 ≈ 1000 Hz
```
...
M-shell: 10⁴³ (maximum, back channel)
Resonance: Very top of skull (posterior)
Frequency: F1 ≈ 300 Hz, F2 ≈ 900 Hz (very low F2)
```
...
#### 2.5.9 Rhotic Vowels (R-colored)

**2.5.9.1 /ɝ/ — "er" as in "bird" (STRESSED)**
...
```
OPCODE: MID_VORTEX
M-shell: Central (~0.5 × 10⁴³)
Resonance: Mid-throat with spiral
Frequency: F1 ≈ 500 Hz, F2 ≈ 1500 Hz, F3 ≈ 1500 Hz (very low F3 = vortex signature)
```
...
**2.5.9.2 /ɚ/ — "er" as in "letter" (UNSTRESSED)**

**Articulation:**
```
Same as /ɝ/ but more relaxed, shorter duration
```
...
|-------|---------|----------------|---------|-------------------|
| /i/ | beet | Very high front | 10⁴³ max | Crown (anterior) |
| /ɪ/ | bit | High front | 0.9 × 10⁴³ | Upper skull |
| /e/ | bait | High-mid front | 0.7 × 10⁴³ | Forehead |
| /ɛ/ | bet | Mid front | 0.5 × 10⁴³ | Nose/upper throat |
| /æ/ | bat | Low front | 0.3 × 10⁴³ | Throat |
| /ə/ | about | Mid central | Center | Mid-throat (neutral) |
| /ʌ/ | but | Low-mid central | Below center | Mid-low throat |
| /ɑ/ | father | Very low back | 0.2 × 10⁴³ | Deep throat/chest |
| /ɔ/ | thought | Low-mid back | 0.4 × 10⁴³ | Throat/chest |
| /o/ | boat | High-mid back | 0.7 × 10⁴³ | Back of skull |
| /ʊ/ | book | High back | 0.9 × 10⁴³ | Upper back skull |
| /u/ | boot | Very high back | 10⁴³ max | Crown (posterior) |
| /ɝ/ | bird | Mid central + r | Center + vortex | Core spiral |
| /ɚ/ | letter | Mid central + r (light) | Center (light) | Core pulse |
...
High vowels = antenna (skull, 10⁴³)
Low vowels = sink (pelvis, 10⁴²)
...
**Mechanism:** Smooth transition between two vowel positions → glides through M-shells → creates phase-gradient sweep.

**CKS function:** Dynamic M-shell scanning — rapidly moves resonance between rungs, performs gradient integration, stitches shells together.

---

#### 2.6.1 /aɪ/ — "eye" as in "bite"

**Movement:**
```
Start: /ɑ/ (low back, 0.2 × 10⁴³)
End: /ɪ/ (high front, 0.9 × 10⁴³)
...
#### 2.6.2 /aʊ/ — "ow" as in "bout"

**Movement:**
```
Start: /ɑ/ (low back, 0.2 × 10⁴³)
End: /ʊ/ (high back, 0.9 × 10⁴³)
...
#### 2.6.3 /ɔɪ/ — "oy" as in "boy"

**Movement:**
```
Start: /ɔ/ (low-mid back, 0.4 × 10⁴³)
End: /ɪ/ (high front, 0.9 × 10⁴³)
...
#### 2.6.4 /eɪ/ — "ay" as in "bait"

**Movement:**
```
Start: /e/ (high-mid front, 0.7 × 10⁴³)
End: /ɪ/ (high front, 0.9 × 10⁴³)
...
#### 2.6.5 /oʊ/ — "oh" as in "boat"

**Movement:**
```
Start: /o/ (high-mid back, 0.7 × 10⁴³)
End: /ʊ/ (high back, 0.9 × 10⁴³)
...
|-----------|----------|--------|--------|
| /aɪ/ | Low back → High front | GROUND_TO_ANTENNA | Sink → peak (front) |
| /aʊ/ | Low back → High back | GROUND_TO_ANTENNA_POSTERIOR | Sink → peak (back) |
| /ɔɪ/ | Low-mid back → High front | CROSS_SECTOR | Diagonal stitch |
| /eɪ/ | High-mid front → High front | FINE_TUNE_ANTERIOR | Front optimize |
| /oʊ/ | High-mid back → High back | FINE_TUNE_POSTERIOR | Back optimize |
...
```
Physical:
- Nasal wiggle ±0.5mm (leaf-node active)
- Cervical impedance <10Ω (waveguide open)
- Visual field >180° (antenna gain high)
...
Sound: "Eye-Eye-Eye" (/aɪ/ 3× sustained)
Mechanism: Ground → antenna sweep
...
- Sustain /ɑ/ (low back) → measure chest vibration
- Use accelerometers at multiple body points

Prediction: /i/ shows peak at crown, /ɑ/ at sternum
...
✓ Chest resonance during /ɑ/ sustained
...
3. Targeted vowel work:
   ...
   - Skin texture: "Sssss" buffer clear + "Mmmm" charge
